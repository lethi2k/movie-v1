        ...
        <div class="d-xl-flex">
            ...
            <div class="card filemanager-sidebar ms-lg-2">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <div class="card border shadow-none mb-2" id="image_popup">
                            <a href="javascript: void(0);" class="text-body" id="button-image-manager">
                                <div class="p-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="overflow-hidden me-auto">
                                            <h5 class="font-size-13 text-truncate mb-1">Thư viện ảnh</h5>
