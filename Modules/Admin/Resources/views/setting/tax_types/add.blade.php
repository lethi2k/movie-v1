...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Thêm mới loại thuế</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Thương mại điện tử</a></li>
                            <li class="breadcrumb-item active">Thêm mới loại thuế</li>
                        </ol>
                    </div>
        ...
        <form action="{{route('admin.setting.tax_types.store')}}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input id="input-title" name="tax_class[title]" type="text"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="textarea-description" rows="5"
                                            name="tax_class[description]" placeholder="Product Description"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="tax_rule[based][]"
                                        id="market_price" value="market_price">
