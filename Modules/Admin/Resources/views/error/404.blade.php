...
<!-- Mirrored from themesbrand.com/skote/layouts/pages-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Dec 2021 16:09:25 GMT -->
        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="text-center mb-5">
                        ...
                        <div class="mt-5 text-center">
                            <a class="btn btn-primary waves-effect waves-light" href="{{$previous}}">Trở về trang chủ</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-8 col-xl-6">
                    <div>
                        <img src="{{URL::asset('admin/assets/images/error-img.png') }}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
