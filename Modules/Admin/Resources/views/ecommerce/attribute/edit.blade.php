...
<div class="page-content">
    <div class="container-fluid">
        ...
        [
            'action' => action('Modules\Admin\Http\Controllers\Ecommerce\AttributeController@update', ['id' => $group->attribute_group_id]),
...
@endsection
@section('js')
@include('admin::ecommerce.attribute.js', ['key' => $group->totalAttribute()])
@endsection