...
<div class="page-content">
    <div class="container-fluid">
        ...
        [
            'action' => action('Modules\Admin\Http\Controllers\Ecommerce\CategoryController@update', ['id' => $category->category_id]),
            'parents' => $parents,
            'parent_id' => $category->parent_id,
            'sort_order' => $category->sort_order,
            'image' =>  strlen($category->image) ? $category->image : URL::asset('images/default.png'),
