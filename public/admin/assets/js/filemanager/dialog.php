<?php
$time = time();
include 'include/pagination_class.php';
...
<html>
    <head>
        ...
        <style>
            .numbers { display: inline-block; width:100%}
            .numbers a { color: black; float: left; padding: 8px 16px; text-decoration: none}
            .numbers a.selected { background-color: #4CAF50; color: white; border-radius: 5px}
            .numbers a:hover:not(.selected) { background-color: #ddd; border-radius: 5px}
        </style>
...
$pagination = new pagination($files, (isset($_GET['page']) ? $_GET['page'] : 1), 61);
...
<!-- header div end -->
    ...
    ?></div>
        ...
        <div class="numbers"><?php echo $pagination->getLinks($_GET) ?></div>
        <?php } ?>
    </div>
    </div>
</div>
