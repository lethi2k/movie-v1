...
// if(!isset($_COOKIE['uploadToken']) || $_COOKIE['uploadToken'] != md5($_SERVER['HTTP_HOST'] . '-iNET$$Zozo!QAZxsw')) {
//     echo('Access denied!');
//     die;
// }
...
$config = [
    ...
    */
    ...
    'ext_file' => [ 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai', 'kmz','dwg', 'dxf', 'hpgl', 'plt', 'spl', 'step', 'stp', 'iges', 'igs', 'sat', 'cgm', 'tiff',''], //Files
